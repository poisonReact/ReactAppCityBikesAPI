...
import InFavorite from 'library/common/commonComponents/inFavorite/inFavoriteStation'
...
interface InputProps {
    ...
    setStationInFavorites: (value: IStation) => void
}

const StationComponent = ({ station, favoriteStations, setStationInFavorites }: InputProps) => {
    return (
